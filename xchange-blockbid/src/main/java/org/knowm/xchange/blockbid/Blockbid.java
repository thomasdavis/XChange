...
public interface Blockbid {
  ...
  List<BlockbidTickerResult> getTicker(@PathParam("currencyPair") String currency)
      throws IOException;

  @GET
  @Path("trades?market={currencyPair}")
  List<BlockbidTradeResult> getMarketTrades(@PathParam("currencyPair") String currency)
      throws IOException;

  @GET
  @Path("orderbook?market={currencyPair}")
  BlockbidOrderBookResult getOrderBook(@PathParam("currencyPair") String currency)
      throws IOException;
}
